...
struct OverlayDATA_232 D232 =
    {
        ...
        .emSet_maskSpawn =
            {
                {.flags = 1, .initOffset = 12, .InitTypes = {.FuncInit = {.particle_colorFlags = 0xa1, .particle_lifespan = 20}}},
                {.flags = 0x1b,
                 .initOffset = 0,
                 .InitTypes = {.AxisInit = {.baseValue = {.startVal = -0x1900, .velocity = -0x640}, .rngSeed = {.startVal = 0x3200, .velocity = 0xc80}}}},
                {.flags = 0x1b,
                 .initOffset = 2,
                 .InitTypes = {.AxisInit = {.baseValue = {.startVal = -0x1900, .velocity = -0x640}, .rngSeed = {.startVal = 0x3200, .velocity = 0xc80}}}},
                {.flags = 0x1b,
                 .initOffset = 1,
                 .InitTypes = {.AxisInit = {.baseValue = {.startVal = -0xc80, .velocity = 0x190}, .rngSeed = {.startVal = 0x1900, .velocity = 0x640}}}},
                {.flags = 3, .initOffset = 5, .InitTypes = {.AxisInit = {.baseValue = {.startVal = 0x800, .velocity = -0x20}}}},
                {.flags = 9, .initOffset = 4, .InitTypes = {.AxisInit = {.baseValue = {.startVal = 1}, .rngSeed = {.startVal = 0x1000}}}},
                {.flags = 5, .initOffset = 7, .InitTypes = {.AxisInit = {.baseValue = {.startVal = 0x8000, .accel = -0x100}}}},
                {.flags = 5, .initOffset = 8, .InitTypes = {.AxisInit = {.baseValue = {.startVal = 0x8000, .accel = -0x100}}}},
                {.flags = 5, .initOffset = 9, .InitTypes = {.AxisInit = {.baseValue = {.startVal = 0x8000, .accel = -0x100}}}},
                {0},
            },
        ...
        .emSet_maskLeave =
            {
                ...
                {.flags = 0x1b,
                 .initOffset = 0,
                 .InitTypes = {.AxisInit = {.baseValue = {.startVal = -0x640, .velocity = -0xc80}, .rngSeed = {.startVal = 0xc80, .velocity = 0x1900}}}},
                {.flags = 0x1b,
                 .initOffset = 2,
                 .InitTypes = {.AxisInit = {.baseValue = {.startVal = -0x640, .velocity = -0xc80}, .rngSeed = {.startVal = 0xc80, .velocity = 0x1900}}}},
                {.flags = 0x1b,
                 .initOffset = 1,
                 .InitTypes = {.AxisInit = {.baseValue = {.startVal = -0x190, .velocity = -0x4b0}, .rngSeed = {.startVal = 0xc80, .velocity = 0xc80}}}},
                {.flags = 3, .initOffset = 5, .InitTypes = {.AxisInit = {.baseValue = {.startVal = 0x1000, .velocity = -0x80}}}},
                {.flags = 9, .initOffset = 4, .InitTypes = {.AxisInit = {.baseValue = {.startVal = 1}, .rngSeed = {.startVal = 0x1000}}}},
                {.flags = 5, .initOffset = 7, .InitTypes = {.AxisInit = {.baseValue = {.startVal = 0x8000, .accel = -0x100}}}},
                {.flags = 5, .initOffset = 8, .InitTypes = {.AxisInit = {.baseValue = {.startVal = 0x8000, .accel = -0x100}}}},
                {.flags = 5, .initOffset = 9, .InitTypes = {.AxisInit = {.baseValue = {.startVal = 0x8000, .accel = -0x100}}}},
