...
typedef struct {
    ...
    bool enableArcadeMultiplayer; // false = 1P/2P arcade, true = allow 3P/4P arcade with AI fill
    ...
    bool disableSplitScreenLod; // false = off (default), true = use full-detail split-screen assets and effects
